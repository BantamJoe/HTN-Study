...
namespace Managers
{
    ...
    {
        private static InternalEventManager _instance = null;

        public static InternalEventManager Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new InternalEventManager();
                }
        ...
        public void DestroyAll<T>() where T : IEvent
        {
            //wanna implement this later
        }
